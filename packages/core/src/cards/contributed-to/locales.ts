...
const contributedToCardLocales = defineLocales({
  ...
  'contributedtocard.footer-top': {
    en: { one: 'top {shown} of {count} repository', other: 'top {shown} of {count} repositories' },
  },
  ...
  'contributedtocard.accessibility-repo': {
    en: { one: '{repo}: {count} contribution', other: '{repo}: {count} contributions' },
  },
  'contributedtocard.accessibility-repo-years': {
    en: {

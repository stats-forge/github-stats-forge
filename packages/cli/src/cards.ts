...
const CARDS: ReadonlyArray<CardKind> = [
  ...
  {
    id: 'org-activity',
    label: 'Organization activity — what an organization did over a window',
    needsToken: true,
    required: [{ name: 'org', label: 'GitHub organization', kind: 'text' }],
    options: [
      {
        ...
        kind: 'integer',
        group: 'data',
        hint: 'The window ends today; 30 by default',
      },
      {
        name: 'show',
        label: 'Extra stats to show',
        kind: 'list',
        group: 'display',
        choices: orgActivity.OPTIONS.show,
        hint: 'Commits cost a second request to GitHub',
      },
      {
        name: 'hide',
        label: 'Stats to hide',
        kind: 'list',
        group: 'display',
        choices: orgActivity.OPTIONS.hide,
      },
      { name: 'show_icons', label: 'Show the stat icons', kind: 'boolean', group: 'display' },
      { name: 'custom_title', label: 'Card title', kind: 'text', group: 'text' },
      { name: 'hide_title', label: 'Hide the title', kind: 'boolean', group: 'text' },
      ...
      { name: 'text_bold', label: 'Bold stat values', kind: 'boolean', group: 'text' },
      {
        ...
        kind: 'choice',
        group: 'text',
        choices: orgActivity.OPTIONS.number_format,
      },
      {
        name: 'disable_animations',
        label: 'Disable the animations',

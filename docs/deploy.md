...
With [github-readme-stats-action](https://github.com/stats-forge/github-stats-forge-action) you can generate static cards in your GitHub Actions workflow, commit them to your profile repository, and embed them directly from there. This avoids any per-request API calls.
  ...
  build:
    ...
    steps:
      ...
      - name: Generate stats card
        uses: stats-forge/github-stats-forge-action@v2
        with:
          card: stats
...
See more options and examples in the [GitHub Readme Stats Action README](https://github.com/stats-forge/github-stats-forge-action#readme).
...
As a prerequisite, GitHub has to know that your personal GitHub-Stats-Extended repo is a fork of https://github.com/stats-forge/github-stats-forge. This only works if you follow the "Step-by-step guide on setting up your own Vercel instance" above, instead of clicking the Vercel "Deploy" button above.
